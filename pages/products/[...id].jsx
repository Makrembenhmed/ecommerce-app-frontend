            ...
            <section className="mt-20 md:mt-6 ">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <Image
                            ...
                            className="w-full h-full md:h-[90vh] object-contain object-center border border-primary rounded-lg"
                            layout="fixed"
                            width={500}
                            height={1000}
                        />
                    ...
                    <div className="p-4 lg:p-8 border">
                        ...
                        <div className="mt-4 flex justify-between items-center">
                            ...
                            <p className="mt-2 text-primary font-semibold text-lg">
                                ...
                                eur {formatPrice(product.price)} 
                            </p>
                        </div>
                        <div className="mt-6">
              <h2 className="text-xl font-semibold text-green-900">Pour Plus de Details: </h2>
              <h2 className="mt-2 text-green-700 list-disc list-inside"> 00216 555455874
