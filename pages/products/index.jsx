            ...
            <div key={product._id}>
              <div className="group block overflow-hidden border border-accent rounded-xl border-opacity-10">
                <div className="relative md:h-[300px] h-[200px]">
                  <img src={product.images[0]} alt="product image" className="absolute inset-0 h-full w-full object-contain 
                  opacity-100 group-hover:opacity-0" />
                  <img src={product.images[1]} alt="product image" className="absolute inset-0 h-full w-full object-contain 
                ...
                <div className="relative p-3 border-t">
                  ...
                  <div className="mt-1.5 flex flex-col items-center justify-between text-text">
                    ...
                    <div class="col-span-12 text-center w-full">
                      <button onClick={()=>{addProduct(product._id); toast.success("item added to Cart ")}} type="button" class=" block rounded bg-secondary px-5 py-3 text-md text-text transition
                     hover:bg-purple-300 w-full ">Add to cart</button>
                    </div>
