                                ...
                                <div className="p-1">
                                    <div className="relative h-[300px] sm:h-[300px]">
                                        <Image
                                            ...
                                            style={{ height: "auto" }}
                                            className="absolute object-fill inset-0 h-full w-full opacity-100 group-hover:opacity-0"
                                        />
                                        <Image
                                            ...
                                            sizes="(max-width: 600px) 100vw, (max-width: 1200px) 50vw, 33vw"
                                            style={{ height: "auto" }}
                                            className="absolute object-fill inset-0 h-full w-full opacity-0 group-hover:opacity-100"
                                        />
                                    </div>
                                    ...
                                    <div className="relative  p-3 border-t">
                                        ...
                                        <div className="mt-1.5 flex items-center justify-between text-text">
                                            ...
                                            }} type="button" className="flex items-center divide-x rounded-lg border border-primary bg-white text-center text-md font-medium text-secondary-700 shadow-sm hover:bg-gray-100">
