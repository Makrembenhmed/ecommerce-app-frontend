          ...
          <div className="flex items-center gap-4">
            <div className="sm:flex sm:gap-4 items-center">
              {session ?(
                <div className='sm:flex sm:gap-2 border-r pr-4 '>
                  <div className="h-9 w-9 ">
                    <img className='h-full w-full rounded-full  object-fill object-center' src={session.user.image} alt={session.user.name} />
                  </div>
                </div>
              ):(
                <Link
                className=" text-sm px-4 py-1 text-center font-medium border-r border-primary transition "
                href="/"
              >
                Account
              </Link>
              ...
              >
                ...
                <span className="mt-2 text-primary font-bold group-hover:text-text ">
                  {cartProducts.length}
                </span>
