          ...
          <div className="relative mx-auto sm:static px-6 lg:px-8">
            <div className="max-w-xl text-start">
              ...
              <div className="flex gap-4 mt-10 items-center max-sm:justify-center max-sm:mt-6">
                <button
                  type="button"
                  className="rounded-lg border border-primary bg-primary px-5 py-2.5 text-center text-md font-medium text-white shadow-sm transition-all hover:border-secondary hover:bg-secondary focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300"
              ...
              <div className="lg:block sm:hidden absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:-translate-x-8">
              ...
              {/* Add this block to display images on small screens */}
              <div className="block lg:hidden mt-10">
                <div className="grid grid-cols-2 gap-4">
                  {product.images.map((image, index) => (
                    <div key={index} className="w-full h-48 overflow-hidden rounded-lg border border-secondary">
